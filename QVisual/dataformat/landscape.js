...
module.exports = exports = {
    ...
    Landscape: function (A) {
        ...
        //for (var RowN = 0; RowN < distMatrix.rows; RowN++) {
        //    for (var ColN = 0; ColN < distMatrix.cols; ColN++) {
        //        if (distMatrix.at(RowN, ColN) < 1e-6) {
        //            distMatrix.put(RowN, ColN, 0);
        //        }
        //        else {
        //            distMatrix.put(RowN, ColN, Math.sqrt(distMatrix.at(RowN, ColN)));
        //        }
        //    }
        //}
        var mds = exports.MDS(distMatrix);
        //var land = qm.la.cat([[lsi.getCol(1).toMat(), lsi.getCol(2).toMat()]])
        return mds;
    },
